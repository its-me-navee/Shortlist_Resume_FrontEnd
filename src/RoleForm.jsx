  ...
  const handleSubmit = async (formData) => {
    try {
      axios.post(
        ...
        "https://wonderful-field-0e0b37400.5.azurestaticapps.net/submit/",
        formData,
        {
          headers: {
    ...
    >
      ...
      >
        ...
        <textarea
          ...
          placeholder="e.g. I joined cv ninja's Customer Success team to help them scale their checkout product. I focused mainly on onboarding new customers and resolving new complaints"
          required
        />
